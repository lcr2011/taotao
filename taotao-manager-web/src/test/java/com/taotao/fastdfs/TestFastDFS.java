...
public class TestFastDFS {
    ...
    public void uploadFile() throws Exception {
        ...
        //3、加载配置文件
        ClientGlobal.init("E:\\JAVA\\Project\\taotao\\taotao-manager-web\\src\\main\\resources\\resource\\client.conf");
//        ClientGlobal.init("D:/workspaces-itcast/JavaEE28/taotao-manager-web/src/main/resources/resource/client.conf");
        ...
        String[] strings = storageClient.upload_file("E:\\JAVA\\Project\\广告图片\\1.jpg", "jpg", null);
//        String[] strings = storageClient.upload_file("D:/Documents/Pictures/images/200811281555127886.jpg", "jpg", null);
    ...
    public void testFastDfsClient() throws Exception {
        FastDFSClient fastDFSClient = new FastDFSClient("E:\\JAVA\\Project\\taotao\\taotao-manager-web\\src\\main\\resources\\resource\\client.conf");
        String string = fastDFSClient.uploadFile("E:\\JAVA\\Project\\广告图片\\2.jpg");
